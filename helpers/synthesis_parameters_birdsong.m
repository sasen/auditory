...
P.constraint_set.sub_kurt = 1;  %% SS trying it out
...
P.constraint_set.mod_C2 = 1;  %% SS trying it out
...
P.orig_sound_filename = 'long.wav';
P.orig_sound_folder = '~/Dropbox/ucsd/projects/auditory/expts/audio/library/'; %must be a string, should have a slash at the end. If this is an empty string, Matlab will search its path for the file.
P.output_folder = '~/Dropbox/ucsd/projects/auditory/expts/audio/STIMULI/fulldur/'; %must be a string, should have a slash at the end. 
...
P.initial_sound_folder = '~/Dropbox/ucsd/projects/auditory/expts/audio/library/';
...
P.iteration_snapshots=[4 8 16 32]; %will save synthetic signal to file at specified iteration numbers
